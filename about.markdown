...
[Wi-Fi Handbook](https://www.mhprofessional.com/) (McGraw-Hill, 2003) with Frank Ohrtman.

## Current Projects

**GoBox** — A portable emergency communications station built around the Icom IC-2820H,
packaged in a Nanuk 920 case with a Windows mini-PC running Winlink, VARA-FM, and
digital modes. Fully documented using systems engineering discipline: requirements,
test plans, RTM traceability. Built for ARES/EMCOMM deployment supporting both
tactical (Jeffco R1D6) and logistical (Bellevue Communications Support) operations.

**AI Partnership Handbook** — A book in progress targeting McGraw-Hill, using the GoBox
build as a primary worked example of AI-assisted systems engineering. The thesis:
AI partnership multiplies engineering leverage — the gain comes from asking the right
...
- AI-assisted engineering — methods, tools, lessons learned
- GoBox build log
- ARES/EMCOMM operations and preparedness

[GitHub](https://github.com/wa4osh) &bull;
[kr@wa4osh.com](mailto:kr@wa4osh.com)
